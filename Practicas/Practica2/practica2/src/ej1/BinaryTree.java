...
public class BinaryTree <T> {		
	...
	public int contarHojas() {   
		...
		// si no soy hoja tengo que bajar a los hijos
	...
	public void entreNiveles(int n, int m){
		...
		int nivelAct = 0;		// nivel de la raiz
		cola.enqueue(this);		
		cola.enqueue(null);		// una "marca", que señala el fin del nivel 0
		...
		while (!cola.isEmpty()) {
			...
			if (ab != null) {
			  ...
			  // Si ab es null, significa que termino un nivel
			  nivelAct ++;
			  cola.enqueue(null);	//otra marca para el siguiente nivel
